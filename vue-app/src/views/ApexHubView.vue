  ...
  <div class="hub-view">
    ...
    <section class="section-card">
      <div class="section-row">
        ...
        <span class="badge-api">Dane z /api/apex/reports</span>
      </div>
    ...
    <section class="section-card">
      <div class="section-row">
        ...
        <span class="badge-api">Dane z /api/apex/alerts</span>
      </div>
    ...
    <div class="api-status">
      ...
      <span v-if="apiOk">APEX API online</span>
      <span v-else>APEX API niedostępne</span>
...
const API_BASE = window.location.origin // relative — ten sam Flask
...
async function fetchAll() {
  const endpoints = {
    kpi: '/api/apex/kpi',
    trends: '/api/apex/trends',
    reports: '/api/apex/reports',
    sla: '/api/apex/sla',
    etl: '/api/apex/etl',
    alerts: '/api/apex/alerts',
  }
...
.bar-fill.transactions { height: 100%; background: linear-gradient(90deg, #ef233c, #ff6b6b); border-radius: 100px; transition: width 0.8s ease; }
...
.legend-dot.trans { background: #ef233c; }
...
.report-status.ready { background: rgba(239,35,60,0.1); color: #ef233c; }
...
.sla-status.ok, .etl-status.stable { background: rgba(239,35,60,0.1); color: #ef233c; }
...
.no-alerts { font-size: 14px; color: #ef233c; padding: 12px 0; }
...
.api-dot.online { background: #ef233c; }
