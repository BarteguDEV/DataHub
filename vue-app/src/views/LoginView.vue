    ...
    <div class="login-card">
      ...
      <div class="card-body">
        <div class="input-group">
          ...
          <input id="user" v-model="username" type="text" placeholder="np. admin" @keyup.enter="login" />
        </div>
        <div class="input-group">
          <label for="pass">Hasło</label>
          <input id="pass" v-model="password" type="password" placeholder="••••••••" @keyup.enter="login" />
        </div>

        <p v-if="error" class="error-msg">{{ error }}</p>

        <button class="btn" :disabled="!username.trim() || loading" @click="login">
